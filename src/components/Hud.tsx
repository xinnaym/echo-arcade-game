    ...
    <div className="pointer-events-none absolute inset-0 z-10 select-none-all p-3 sm:p-5">
      ...
      <div className="flex items-start justify-between gap-2">
        <Plate className="min-w-[104px]">
          <div className="text-[10px] font-semibold tracking-[0.22em] text-ink/55">{t("hud.points")}</div>
          <div className="tabnum font-display text-3xl leading-none font-bold text-ink sm:text-4xl">{hud.points}</div>
          <div className="tabnum mt-0.5 text-[10px] tracking-wide text-ink/45">{t("hud.record", { n: best })}</div>
        </Plate>

        <div className="flex flex-1 flex-col items-center gap-1.5">
          <Plate className="w-full max-w-[260px]">
            <div className="mb-1 flex items-baseline justify-between">
              <span className="text-[10px] font-semibold tracking-[0.22em] text-ink/55">{t("hud.wind")}</span>
              <span
                className={
                  "tabnum text-[10px] font-semibold " + (low ? "animate-pulse text-rust" : "text-ink/45")
                }
              >
        ...
        <div className="flex flex-col items-end gap-1.5">
          <Plate className="text-right">
            <div className="text-[10px] font-semibold tracking-[0.22em] text-ink/55">{t("hud.chrono")}</div>
            <div className="tabnum font-display text-2xl leading-none font-bold text-ink sm:text-3xl">
              {fmtTime(hud.time)}
            </div>
            <div className="tabnum mt-0.5 text-[10px] tracking-wide text-ink/45">
      ...
      <div className="absolute inset-x-3 bottom-3 flex items-end justify-between gap-3 sm:inset-x-5 sm:bottom-5">
        <div className="hidden text-[11px] leading-relaxed tracking-wide text-ink/45 sm:block">
        ...
        >
          <div
            className="absolute inset-0 origin-bottom bg-brass/35 transition-[height] duration-100"
            style={{ height: `${hud.dash * 100}%`, top: "auto", bottom: 0 }}
          />
          <svg
